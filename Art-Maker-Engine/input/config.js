...
const description = "Salmaan's first nft collection";
// base url in case no unique metadata file i.e IPFS
const baseImageUri = "https://ubvd0n7swfr2.usemoralis.com:2053/server";
...
const layers = [
  addLayer("Head", { x: 0, y: 0 }, { width: width, height: height }),
  addLayer("Eyes"),
  addLayer("Mouth"),
  addLayer("Extra"),
];
